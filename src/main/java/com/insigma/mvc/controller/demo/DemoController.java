...
public class DemoController extends MvcHelper<DemoAc01> {
	...
	public AjaxReturnMsg<HashMap<String, Object>> apiGetAc01List(HttpServletRequest request,  DemoAc01 ac01 ) throws Exception {
	...
	public AjaxReturnMsg<String> savedata(HttpServletRequest request, @Valid DemoAc01 ac01,BindingResult result) throws Exception {
		//检验输入
		if (result.hasErrors()){
