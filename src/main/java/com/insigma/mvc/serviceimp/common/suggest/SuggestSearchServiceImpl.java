 ...
 */
@Service
public class SuggestSearchServiceImpl extends MvcHelper<SuggestKey> implements SuggestSearchService {

	@Resource
	private SuggestSearchMapper suggestSearchMapper;

	@Override
	public AjaxReturnMsg<HashMap<String,List<SuggestKey>>> searchByKey(SuggestKey key) {
		...
		map.put("value", list);
		return this.success_hashmap_response(map);
	}
}