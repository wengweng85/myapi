...
public class DemoAc01ServiceImpl extends MvcHelper<DemoAc01> implements DemoAc01Service {
	 ...
	 */
	@Override
	public AjaxReturnMsg<DemoAc01> getDemoById(String aac001) {
		return this.success(demoDemoAc01Mapper.selectByPrimaryKey(aac001));
	}
	 ...
	 */
	@Override
	public AjaxReturnMsg<DemoAc01> getDemoNameById(String aac001) {
		return this.success(demoDemoAc01Mapper.selectNameByPrimaryKey(aac001));
	}
